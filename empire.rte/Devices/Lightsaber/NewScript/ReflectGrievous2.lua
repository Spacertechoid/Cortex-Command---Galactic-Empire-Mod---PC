...
function Update(self)
  ...
  if MovableMan:IsActor(self.parent) and self.RootID == self.parent.ID then
	...
	if not self.ReflectTimer:IsPastSimMS(310 - (20 * self.parent.Sharpness)) then
		...
		self.RotAngle = angle + .15 * self.negatore;
	end
	...
	if self.SpinTimer:IsPastSimMS(435 - (20 * self.parent.Sharpness)) and self.ReflectTimer:IsPastSimMS(370) and self.BlockAngle == 0 then
		...
		self.anglemodifier = angmod - 0.26 * posneg
