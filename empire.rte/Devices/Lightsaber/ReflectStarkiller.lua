...
--SHIELD
   ...
   if particle.HitsMOs == false then
	...
	if pardist.Magnitude < 21 and particle.PresetName == "Lightsaber Killing B" and particle.Team ~= self.Team then
		if self.ammoCounter > 1 then
